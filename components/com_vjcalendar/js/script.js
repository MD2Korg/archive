...
function Calendar(element, instanceOptions) {
	...
	function getAndRenderEvents() {
		...
		vjJQuery('.fc-event-inner').tooltipster({position: "bottom", theme: 'tooltipster-' + window.ttheme, contentAsHTML: true, interactive: true});
	}
	...
	function _fetchEventSource(source, callback) {
		...
		if (events) {
			...
			if (url) {
				...
				/* VJ Tools fix for Google Calendar v3 */
				if (startParam) {
					data[startParam] = rangeStart.format() + 'T00:00:00+00:00';
				}
				if (endParam) {
					data[endParam] = rangeEnd.format() + 'T23:59:59+00:00';
				}
				/* VJ Tools fix for Google Calendar v3 */
	...
	function slotSegHtml(event, seg) {
		...
		html +=
			...
			" style=" +
				...
				"'" +
			">" +
			/* VJ fix for description - START */
			/*"<div class='fc-event-inner'>" +*/
			"<div class='fc-event-inner' title='" + event.description + "'>" +
			/* VJ fix for description - END */
...
/**
 * Script created in Codrops article: http://tympanus.net/codrops/2012/11/27/calendario-a-flexible-calendar-plugin/
			...
			for ( var i = 0; i < 7; i++ ) {
				...
				for ( var j = 0; j <= 6; j++ ) {
					...
					if ( day <= monthLength && ( i > 0 || j >= p ) ) {
						...
						var cssStr = ( this.month + 1 < 10 ? '0' + ( this.month + 1 ) : this.month + 1 ) + '_' + ( day < 10 ? '0' + day : day ) + '_' + this.year
						...
						if( content !== '' ) {
							inner += '<div style="display:none">' + content + '</div>';
						}
					...
					if( content !== '' ) {
						cellClasses += 'fc-content cell_' + cssStr;
					}
